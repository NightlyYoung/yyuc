...
class Conf{
/////////////////////框架管理中心登录配置
        public static $version_control_v = 0;
        public static $version_control_build = 0002;
	...
	public static $management_center_password = "0ducc";
/////////////////////数据库配置 编码必须为 utf-8
	/**数据库地址~*/
...
/////////////////////常用配置	
        /**自定义的日志记录**/
        public static $is_need_log = '0';//1开启 0关闭
